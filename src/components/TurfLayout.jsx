                    ...
                    <div className="grid gap-4 h-full">
                        {
                            turfData.map((turf) => (
                                <div
                                    key={turf.pitchNo}
                                    className={`flex h-full justify-center items-center rounded-md overflow-hidden shadow-sm cursor-pointer ${
                                        selectedTurf === turf.pitchNo
                                            ? 'bg-blue-500 text-white' 
                                            
                                                : 'bg-white'
                                    }`}
                                    onClick={() => setSelectedTurf(turf.pitchNo)} 
                                >
                                    <div className="p-4 text-center">
                                        <p className="text-lg font-semibold">{turf.pitchNo}</p>
                                    </div>
                                </div>
                            ))
                        }
